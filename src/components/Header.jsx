				...
				<div className="flex items-center gap-8">
					...
					<div className="relative">
						...
						{isMenu && (
							...
							>
								{user && user.email === "amanpreetsingh369@gmail.com" && (
									<Link to={"/createItem"}>
								...
								<p
									className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all ease-in-out text-textColor text-base"
									onClick={logout}
								>
									Logout <MdLogout />
								</p>
				...
				<div className="relative">
					...
					{isMenu && (
						...
						>
							...
							<p
								className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all ease-in-out text-textColor text-base"
								onClick={logout}
							>
								Logout <MdLogout />
							</p>
